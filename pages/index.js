      ...
      <Container className="pt-3">
        <Row>
          <Col className="align-items-center">
            ...
            >
              <PopoverBody>
                Add items you're unsure of getting rid of. Rate them based on
                how happy they make you. Click 'Analyze' when you're done to see
                what you need to part ways with
              </PopoverBody>
            </Popover>
          </Col>
